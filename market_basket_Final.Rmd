...
order products_train
https://drive.google.com/open?id=1FB1ElGO7LKx6Ga5IIP7CDvTo_rYYIYeu
...
order_products_prior = read.csv(url("./input/order_products__prior.csv"))
order_products_train = read.csv(url("./input/order_products__train.csv"))
```
